...
export class SignupPage {
  ...
  constructor(readonly page: Page) {
    ...
    this.firstNameHelperText = page
      .getByTestId("signup-first-name")
      .locator("#firstName-helper-text");
    ...
    this.confirmPasswordHelperText = page
      .getByTestId("signup-confirmPassword")
      .locator("#confirmPassword-helper-text");
