...
export class BankAccountFormPage extends AppPage {
  ...
  constructor(protected readonly page: Page) {
    ...
    this.routingNumberInput = this.form
      .getByTestId("bankaccount-routingNumber-input")
      .locator("input");
    this.routingNumberHelperText = this.form.locator(
      "#bankaccount-routingNumber-input-helper-text"
    );

    this.accountNumberInput = this.form
      .getByTestId("bankaccount-accountNumber-input")
      .locator("input");
    this.accountNumberHelperText = this.form.locator(
